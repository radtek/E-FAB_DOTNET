<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pp_performance_daily_monitor.aspx.cs" Inherits="OEE_pp_performance_daily_monitor" %>
          ...
          <asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <table id="Table3" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td align="middle" style="width: 888px; height: 910px;">
                        <table align="center" cellspacing="0" bordercolordark="#ffffff" cellpadding="2" width="90%"
                            ...
                            <tr>
                                <td  colspan="8" style="height: 35px">
                                    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="Black" GridLines="Vertical" OnRowDataBound="GridView1_RowDataBound" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" >
                                    ...
                                    <br />
                                    <DCWC:Chart ID="Chart1" runat="server" BackColor="Wheat" BorderLineColor="Blue"
                                        EnableViewState="True" Height="500px" Width="1880px">
                                        <Legends>
                                            <DCWC:Legend Alignment="Center" Docking="Top" Name="Default">
                                            </DCWC:Legend>
                                        </Legends>
                                        <Titles>
                                            <DCWC:Title Name="Title1" Text="OEE Trend Chart ">
                                            </DCWC:Title>
                                        </Titles>
                            ...
                            <tr>
                                <td colspan="8" style="height: 35px">
                                     ...
                                     <DCWC:Chart ID="Chart2" runat="server" BackColor="Wheat" BorderLineColor="Blue"
                                        EnableViewState="True" Height="500px" Width="1880px">
                                        <Legends>
                                            <DCWC:Legend Alignment="Center" Docking="Top" Name="Default">
                                            </DCWC:Legend>
