<%@ Page Language="C#" AutoEventWireup="true" CodeFile="st_C2A_tacttime_config.aspx.cs" Inherits="OEE_st_C2A_tacttime_config" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>st c2 atacttime config remind</title>
</head>
<body>
    ...
    <div>
        ...
        <strong><span style="color: #0000ff">
            C2OEE &nbsp; ST Tactime&nbsp; Setting &nbsp;Config&nbsp; Remind</span></strong><br />
        </span></span>
        <br />
