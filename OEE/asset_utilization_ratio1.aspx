<%@ Page Language="C#" AutoEventWireup="true" CodeFile="asset_utilization_ratio1.aspx.cs" Inherits="OEE_asset_utilization_ratio1" %>
...
<head id="Head1" runat="server">
    <title>asset_utilization_ratio</title>
                ...
                <tr>
                    ...
                    <td align="middle" style="width: 888px; height: 500px;">
                        <table align="center" cellspacing="0" bordercolordark="#ffffff" cellpadding="2" width="90%"
                                    ...
                                    <table width="100%"  >
                                        <tr>
                                            <td align="left" style="width: 533px">
                                                <span id="Span1" style="font-size: 16pt; font-family: Century Gothic"><strong>NEW 14 STATE 資產利用率系統-查詢</strong></span></td>
                            ...
                            <tr>
                                <td align="center" class="pageTD" style="width: 15%; height: 9px">
                                    開始時間From</td>
                                <td align="left" style="height: 9px" colspan="3">
