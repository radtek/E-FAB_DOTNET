<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TP_balanceX.aspx.cs" Inherits="TP_TP_balanceX" %>
...
<body>
    <form id="form1" runat="server">
        <div id='hiddenDiv'  style="display: inline; z-index: 105; left: 10px; width: 90%; color: black;
                                        ...
                                        <table width="100%">
                                            <tr>
                                                <td style="height: 386px">
                                                    <DCWC:Chart ID="Chart1" runat="server" Height="390px" Width="900px" BackColor="Wheat"
