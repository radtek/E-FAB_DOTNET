...
public partial class CL1_scrap_detail : System.Web.UI.Page
{
    ...
    {
        string sql = " select t.productspecname,t.processflowname,t2.producttype,t.lotname,t2.productname,t2.processoperationname,t.eventname,t.eventtime,t.productiontype,t.carriername,t.eventcomment,t.eventuser,t2.subproductquantity1 from lothistory t,product t2 " +
" where t.lotname in (select t3.lotname from cl_scrap t3  where                                                                                                                                                                                           " +
"  t3.shift_date>='" + txtEstimateStartDate.SelectedDate.Value.ToString("yyyy/MM/dd").Replace("/", "") + "'                                                                                                                                                                                                                  " +
...
" and t.timekey=t2.lasteventtimekey                                                                                                                                                                                                                ";
        ...
        {
            sql = sql + "and t2.factoryname='" + DropDownList1.SelectedValue + "'";
        }

        if (!DropDownList2.SelectedValue.Equals("請選擇"))
        {
            sql = sql + "and t.eventname='" + DropDownList2.SelectedValue + "'";
        }


        if (!ListBox4.Items[0].Text.Equals("請選擇"))
        {
            sql = sql + "and t.lotname in (" + combine_List_box(ListBox4) + ")";
        }
