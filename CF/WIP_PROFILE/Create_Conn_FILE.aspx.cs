...
public partial class CF_WIP_PROFILE_Create_Conn_FILE : System.Web.UI.Page
{
   ...
   'Set common parameter                                 <BR>
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //add_step("2914_CFSorter_ByEQP", "2915_OC_OVEN");
    ...
    public void delete_step(string delete_step)
    {
        ...
        sql2 = " select t.sn,t.stepname from cf_wipprofile_config t " +
" where t.stepname='" + delete_step + "'                      ";
        ...
        sql4 ="select  t.sn,t.stepname  from cf_wipprofile_config t   "+
        ...
        for (int i = 0; i <= ds_temp2.Tables[0].Rows.Count-1; i++)
        {
            ...
            sql5 = " update cf_wipprofile_config t     " +
"   set t.sn =" + down_sn + "               " +
"      where t.sn=" + ds_temp2.Tables[0].Rows[i]["sn"] + "              ";
        ...
        sql3 = " delete cf_wipprofile_config t " +
"  where t.stepname='" + delete_step + "'          ";
  ...
  " where t.stepname='" + target_step + "'                      ";
        ...
        sql3 = " select t.sn,t.stepname from cf_wipprofile_config t" +
"             " +
...
"      where t.stepname='" + ds_temp2.Tables[0].Rows[i]["stepname"] + "'              ";
        ...
        sql4 = " insert into cf_wipprofile_config  " +
 "   (sn, stepname)                  " +
 " values                            " +
 "   (" + counter + ", '" + add_step + "')                   ";
    ...
    public void create_code()
    {
        ...
        sql = "select t.sn,t.stepname from cf_wipprofile_config t order by t.sn";
