<%@ Page Language="C#" AutoEventWireup="true" CodeFile="task_assign_mail.aspx.cs"
    Inherits="task_assign_mail" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Task Assign Mail</title>
        ...
        <div>
            <table cellspacing="0" cellpadding="2" width="100%" 
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:Label ID="lblTaskNo" runat="server" Style="font-size: 13px; font-family: Arial;
                            color: Navy;">
                        </asp:Label>
                    </td>
                    <td align="center" style="font-weight: bold; font-size: 12px; font-family: Arial;
                    ...
                    <td align="left">
                        <asp:Label ID="lblTaskType" runat="server" Style="font-size: 13px; font-family: Arial;
                ...
                <tr>
                    ...
                    <td align="left" colspan="5">
                        <asp:Label ID="lblTaskDesc" runat="server" Style="font-size: 13px; font-family: Arial;
                            color: Navy;"> </asp:Label>
                    </td>
                </tr>
                <tr>
                                ...
                                <tr>
                                    <td>
                                        <asp:DataList ID="dlProcessHistory" runat="server" RepeatDirection="Horizontal" RepeatColumns="1"
                                            Width="100%">
                                            <ItemTemplate>
                                                <table width="100%" cellspacing="0" cellpadding="2" style="border-color:White"
                                                    border="1">
                                                    <tr>
