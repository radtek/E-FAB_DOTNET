...
<asp:UpdateProgress ID="UpdateProgress1" runat="server">
    <ProgressTemplate>
        <div id="IMGDIV" style="position:absolute; left:85%; top:10; visibility:visible; vertical-align:middle; border:solid 2px black; background-color:White; z-index:99999; vertical-align:middle; text-align:center; padding:10px;">
