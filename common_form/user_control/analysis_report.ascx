<%@ Control Language="C#" AutoEventWireup="true" CodeFile="analysis_report.ascx.cs" Inherits="common_form_user_control_analysis_report" %>
<fieldset>
    <legend id="legend1" runat="server" style="font-weight: bold; font-size: 12px; font-family: Arial;
        color: black">Task Detial (<asp:Image runat="server" ID="image1" ImageUrl="~/images/td/sign.gif" />是Owner ) </legend>
            ...
            <td align="left">
                <table>
                    <tr>
                        ...
                        <td><asp:Label ID="Title" runat="server" Font-Size ="11px"></asp:Label></td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <asp:GridView ID="gvTask" runat="server" AutoGenerateColumns="False" CellPadding="4"
        ...
        <Columns>
            <asp:TemplateField>
                ...
                <ItemStyle Width="40px" Font-Size="9pt" HorizontalAlign="Left" VerticalAlign="Top" />
            </asp:TemplateField>
            ...
            <asp:BoundField HeaderText="Task" DataField="task_desc" ItemStyle-Width="200px" ItemStyle-Font-Bold="true" ItemStyle-HorizontalAlign="Left" />
            ...
            <asp:TemplateField HeaderStyle-Width="75px" ItemStyle-HorizontalAlign="Right">
                <HeaderTemplate>
                    <img src="<%=Context.Request.ApplicationPath%>/images/td/user2.gif" />
                </HeaderTemplate>
                <ItemTemplate>
    ...
    <asp:Label runat="server" ID="lblAnalysisType" Style="display: none"></asp:Label>
    <asp:Label runat="server" ID="lblYearMonth" Style="display: none"></asp:Label>
    <asp:Label runat="server" ID="lblYear" Style="display: none"></asp:Label>
    <asp:Label runat="server" ID="lblMonth" Style="display: none"></asp:Label>    
</fieldset>
