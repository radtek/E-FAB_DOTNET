...
namespace Innolux.Portal.CommonFunction
{
	...
	{
		#region Members
		protected Dundas.Charting.WebControl.Chart ChartObj = null;
		...
		/// </summary>
		public Dundas.Charting.WebControl.Chart Chart
		{
			get
			{
				return ChartObj;
		...
		/// </summary>
		public ChartDataTableHelper(Dundas.Charting.WebControl.Chart chartObj)
		{
			ChartAreas = new ArrayList();
			Initialize(chartObj);
		}
		...
		/// </summary>
		public ChartDataTableHelper(Dundas.Charting.WebControl.Chart chartObj, string chartAreaName)
		{
			ChartAreas = new ArrayList();
		...
		/// set a boolean to show or hide total columns.
		/// </summary>
		public void Initialize(Dundas.Charting.WebControl.Chart chartObj, string chartAreaName, bool addTableTotals)
		{
			ChartObj = chartObj;
			AddTableTotals = addTableTotals;
				...
				if(chartAreaName == ser.ChartArea)
				{
					...
					foreach(DataPoint dp in ser.Points)
					{
						...
						ChartObj.ChartAreas[chartAreaName].AxisX.CustomLabels.Add(
							...
							Row, LabelMark.None, GridTick.None
							);
		...
		{
			if(ChartObj.ChartAreas.GetIndex(chartAreaName) >= 0)
