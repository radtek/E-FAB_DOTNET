<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Hold_detail.aspx.cs" Inherits="CL1_Hold_detail" %>
...
<body>
    <form id="form2" runat="server">
        <div style="display: inline; z-index: 105; left: 10px; width: 90%; color: black;
            ...
            <br />
            <table id="Table1" align="center" border="0" cellpadding="0" cellspacing="0" width="85%">
                <tr>
                    <td style="height: 9px">
                        ...
                        <table align="center" cellspacing="0" bordercolordark="#ffffff" cellpadding="2" width="100%"
                            ...
                            <tr>
                                <td background="" colspan="4" class="pageTitle">
                                    <table width="100%">
                                        <tr>
                                            <td align="left">
                                                <span id="Span2" style="font-size: 16pt; font-family: Century Gothic"><strong>CL1_Hold_Detail</strong></span></td>
                            ...
                            <tr>
                                <td class="pageTD" colspan="8" style="height: 35px">
                                    <asp:Button ID="Button9" runat="server" Style="font-size: 12px; font-family: Arial;
                                        width: 100px;" Text="Query" OnClick="ButtonQuery_Click" />
                                    &nbsp;&nbsp;
                                    <asp:Button ID="Button10" runat="server" Style="font-size: 12px; font-family: Arial;
                                                ...
                                                <td style="height: 175px">
                                                    ...
                                                    <asp:GridView ID="GridView1" runat="server" Font-Names="Arial" Font-Size="12px" Width="1000px"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="shift_day_key">
                                                              <ItemTemplate>
                                                          
                                                                    <asp:Label ID="lblshift_day_key" runat="server" ForeColor="Blue"  Text='<%# Bind("shift_day_key") %>'></asp:Label></br>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            
                                                             <asp:TemplateField HeaderText="lasteventtime">
                                                              <ItemTemplate>
                                                          
                                                                    <asp:Label ID="lbllasteventtime" runat="server" ForeColor="Blue" Text='<%# Bind("lasteventtime") %>'></asp:Label></br>
                                                             ...
                                                             <asp:TemplateField HeaderText="factoryname">
                                                              <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="lblfactoryname" runat="server" ForeColor="Blue"  Text='<%# Bind("factoryname") %>'></asp:Label></br>
                                                             ...
                                                             <asp:TemplateField HeaderText="processflowname">
                                                              <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="processflowname" runat="server" ForeColor="Blue"  Text='<%# Bind("processflowname") %>'></asp:Label></br>
                                                             ...
                                                             <asp:TemplateField HeaderText="lasteventname">
                                                              <ItemTemplate>
                                                          
                                                                    <asp:Label ID="lasteventname" runat="server" ForeColor="Blue"  Text='<%# Bind("lasteventname") %>'></asp:Label></br>
                                                             ...
                                                             <asp:TemplateField HeaderText="lasteventuser">
                                                              <ItemTemplate>
                                                          
                                                                    <asp:Label ID="lbllasteventuser" runat="server" ForeColor="Blue"  Text='<%# Bind("lasteventuser") %>'></asp:Label></br>
                                                            ...
                                                            <asp:TemplateField HeaderText="hold_hrs">
                                                              <ItemTemplate>
                                                          
                                                                    <asp:Label ID="lblhold_hrs" runat="server" ForeColor="Blue"  Text='<%# Bind("hold_hrs") %>'></asp:Label></br>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="reasoncode">
                                                              <ItemTemplate>
                                                          
                                                                    <asp:Label ID="lblreasoncode" runat="server" ForeColor="Blue"  Text='<%# Bind("reasoncode") %>'></asp:Label></br>
