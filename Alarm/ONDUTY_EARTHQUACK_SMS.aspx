<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ONDUTY_EARTHQUACK_SMS.aspx.cs" Inherits="Alarm_ONDUTY_EARTHQUACK_SMS" %>
...
<head id="head1" runat="server">
    <title>ONDUTY_EARTHQUACK_SMS</title>
                ...
                <tr>
                    ...
                    <td align="middle" width="100%">
                        <table align="center" cellspacing="0" bordercolordark="#ffffff" cellpadding="2" width="100%"
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="left" style="height: 30px">
                                                <span id="Span1" style="font-size: 16pt; font-family: Century Gothic"><strong>EARTHQUACK_CHECK_SMS</strong></span></td>
                                            <td align="right" style="font-size: 12px; color: navy; height: 30px;">
                                                <span style="color: #ff0000">(*)必填寫</span></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            <tr style="font-size: 12pt">
                                <td class="pageTD" align="left" valign="middle" style="height: 22px; width: 10%;
                                    text-align: left;">
                                    選擇功能</td>
                            ...
                            <tr style="font-size: 12pt">
                                <td align="center" class="pageTD" style="width: 10%; height: 22px; text-align: left"
                                    valign="middle">
                                    trx_id</td>
                                <td style="width: 341px; height: 22px; text-align: left" valign="top">
                                    <asp:TextBox ID="TextBox_trx_id" runat="server" Width="500px"></asp:TextBox></td>
                            </tr>
                            <tr style="font-size: 12pt">
                                <td align="center" class="pageTD" style="width: 10%; height: 22px; text-align: left"
                                    valign="middle">
                                    type_id</td>
                                <td style="width: 341px; height: 22px; text-align: left" valign="top">
                                    <asp:TextBox ID="TextBox_type_id" runat="server" Width="500px"></asp:TextBox></td>
                            </tr>
                            <tr style="font-size: 12pt">
                                <td align="center" class="pageTD" style="width: 10%; height: 22px; text-align: left"
                                    valign="middle">
                                    fab_id<span style="color: red">(*)</span></td>
                                <td style="width: 341px; height: 22px; text-align: left" valign="top">
                                    <asp:TextBox ID="TextBox_fab_id" runat="server" Width="500px"></asp:TextBox></td>
                            </tr>
                            <tr style="font-size: 12pt">
                                <td align="center" class="pageTD" style="width: 10%; height: 22px; text-align: left"
                                    valign="middle">
                                    sys_type<span style="color: red">(*)</span></td>
                                <td style="width: 341px; height: 22px; text-align: left" valign="top">
                                    <asp:TextBox ID="TextBox_sys_type" runat="server" Width="500px"></asp:TextBox></td>
                            </tr>
                            <tr style="font-size: 12pt">
                                <td align="center" class="pageTD" style="width: 10%; height: 22px; text-align: left"
                                    valign="middle">
                                    eq_id<span style="color: red">(*)</span></td>
                                <td style="width: 341px; height: 22px; text-align: left" valign="top">
                                    <asp:TextBox ID="TextBox_eq_id" runat="server" Width="500px"></asp:TextBox></td>
                            </tr>
                            <tr style="font-size: 12pt">
                                <td align="center" class="pageTD" style="width: 10%; height: 22px; text-align: left"
                                    valign="middle">
                                    alarm_id<span style="color: red">(*)</span></td>
                                <td style="width: 341px; height: 22px; text-align: left" valign="top">
                                    <asp:TextBox ID="TextBox_alarm_id" runat="server" Width="500px"></asp:TextBox></td>
                            </tr>
                            <tr style="font-size: 12pt">
                                <td align="center" class="pageTD" style="width: 10%; height: 22px; text-align: left"
                                    valign="middle">
                                    alarm_text<span style="color: red">(*)</span></td>
                                <td style="width: 341px; height: 22px; text-align: left" valign="top">
                                    <asp:TextBox ID="TextBox_alarm_text" runat="server" Width="500px"></asp:TextBox></td>
                            </tr>
                            <tr style="font-size: 12pt">
                                <td align="center" class="pageTD" style="width: 10%; height: 22px; text-align: left"
                                    valign="middle">
                                    mail_contenttype</td>
                                <td style="width: 341px; height: 22px; text-align: left" valign="top">
                                    <asp:TextBox ID="TextBox_mail_contenttype" runat="server" Width="500px"></asp:TextBox></td>
                            </tr>
                            <tr style="font-size: 12pt">
                                <td align="center" class="pageTD" style="width: 10%; height: 22px; text-align: left"
                                    valign="middle">
                                    alarm_comment<span style="color: red">(*)</span></td>
                                <td style="width: 341px; height: 22px; text-align: left" valign="top">
                                    <asp:TextBox ID="TextBox_alarm_comment" runat="server" Width="500px"></asp:TextBox></td>
                            </tr>
                            <tr style="font-size: 12pt">
                                <td align="center" class="pageTD" style="width: 10%; height: 22px; text-align: left"
                                    valign="middle">
                                    pc_ip</td>
                                <td style="width: 341px; height: 22px; text-align: left" valign="top">
                                    <asp:TextBox ID="TextBox_pc_ip" runat="server" Width="500px"></asp:TextBox></td>
                            </tr>
                            <tr style="font-size: 12pt">
                                <td align="center" class="pageTD" style="width: 10%; height: 22px; text-align: left"
                                    valign="middle">
                                    pc_name</td>
                                <td style="width: 341px; height: 22px; text-align: left" valign="top">
                                    <asp:TextBox ID="TextBox_pc_name" runat="server" Width="500px"></asp:TextBox></td>
                            </tr>
                            <tr style="font-size: 12pt">
                                <td align="center" class="pageTD" style="width: 10%; height: 22px; text-align: left"
                                    valign="middle">
                                    operator</td>
                                <td style="width: 341px; height: 22px; text-align: left" valign="top">
                                    <asp:TextBox ID="TextBox_operator" runat="server" Width="500px"></asp:TextBox></td>
                            </tr>
                            <tr style="font-size: 12pt">
                                <td align="center" class="pageTD" style="width: 10%; height: 22px; text-align: left"
                                    valign="middle">
                                    issue_date</td>
                                <td style="width: 341px; height: 22px; text-align: left" valign="top">
                                    <asp:TextBox ID="TextBox_issue_date" runat="server" Width="500px" Enabled="False"></asp:TextBox></td>
                            </tr>
                            <tr>
                                        ...
                                        <tr>
                                            <td align='left' valign='top' style="width: 14px; height: 17px;">
                                                <asp:Button ID="ButtonQuery" runat="server" Style="font-size: 12px; font-family: Arial;
                                                    width: 100px;" Text="Send" OnClick="ButtonQuery_Click" />
                                                &nbsp;&nbsp;&nbsp;
                                            </td>
