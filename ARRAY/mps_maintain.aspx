<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mps_maintain.aspx.cs" Inherits="ARRAY_mps_maintain" %>
                        ...
                        <table align="center" cellspacing="0" bordercolordark="#ffffff" cellpadding="2" width="100%"
                            ...
                            <tr>
                                <td background="" colspan="4" class="pageTitle">
                                    <table width="100%">
                                        <tr>
                                            <td align="left">
                                                <span id="Span1" style="font-size: 16pt; font-family: Century Gothic"><strong>Mps
                            ...
                            <tr style="font-size: 12pt">
                                ...
                                <td style="width: 127px; height: 22px; text-align: left" valign="top">
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/ARRAY/sample_file/mps_sample.xls">EXCEL格式下載</asp:HyperLink><asp:Button
