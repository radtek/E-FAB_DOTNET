...
public partial class CommonForm_UserControl_Scheduler_MonthlySetting : System.Web.UI.UserControl
{
    public Trigger GetTrigger()
    {
        ...
        Trigger trigger = TriggerUtils.MakeMonthlyTrigger(int.Parse(this.ddlDayOfMonth.SelectedValue), int.Parse(temp[0]), int.Parse(temp[1]));
