<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HourlySetting.ascx.cs" Inherits="CommonForm_UserControl_Scheduler_HourlySetting" %>
...
<table cellspacing="1" cellpadding="1" width="100%" style="padding:0;background-color:#8DB2E3;">
    ...
    <tr style="height:25px">
        <td style="background-color:#E6F3FF; width:40%; font-weight:bold;">Interval Hour</td>
        <td style="background-color:#fff">
            <telerik:RadNumericTextBox ID="txtIntervalHour" runat="server" ShowSpinButtons="True" 
